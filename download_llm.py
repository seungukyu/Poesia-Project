...
if __name__ == '__main__':
    ...
    ### Llama series
    if args.hf_model_type == 'llama3.2-3b':
        model_name = 'meta-llama/Llama-3.2-3B-Instruct'
    elif args.hf_model_type == 'llama3.1-8b':
        model_name = 'meta-llama/Llama-3.1-8B-Instruct'
    elif args.hf_model_type == 'llama3-8b':
        model_name = 'meta-llama/Meta-Llama-3-8B-Instruct'
    elif args.hf_model_type == 'llama3ko-8b':
        model_name = 'beomi/Llama-3-Open-Ko-8B-Instruct-preview'
        
    ### Qwen series
    elif args.hf_model_type == 'qwen2.5-7b':
        model_name = 'Qwen/Qwen2.5-7B-Instruct'
    elif args.hf_model_type == 'qwen2-7b':
        model_name = 'Qwen/Qwen2-7B-Instruct'
        
    ### EXAONE series
    elif args.hf_model_type == 'EXAONE3.5-7.8b':
        model_name = 'LGAI-EXAONE/EXAONE-3.5-7.8B-Instruct'
    elif args.hf_model_type == 'EXAONE3-7.8b':
        model_name = 'LGAI-EXAONE/EXAONE-3.0-7.8B-Instruct'
    elif args.hf_model_type == 'None':
